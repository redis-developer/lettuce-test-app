...
public class RedisCommandsClusterAsyncWorkload extends BaseWorkload {

    private final StatefulRedisClusterConnection<String, String> conn;

    public RedisCommandsClusterAsyncWorkload(StatefulRedisClusterConnection<String, String> conn,
            CommonWorkloadOptions options) {
        super(options);
        this.conn = conn;
    }
    ...
    public void run() {
        ...
        RedisClusterAsyncCommands<String, String> cmd = withMetrics(conn.async());
